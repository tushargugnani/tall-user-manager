        ...
        <div class="mt-2 w-full">
              <div class="flex flex-wrap -mx-3 my-6">
                <div class="w-full px-3">
                  ...
                  <input wire:model.defer="user.name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Provide User's Name">
        ...
        <div class="mt-2 w-full">
              <div class="flex flex-wrap -mx-3 my-6">
                <div class="w-full px-3">
                  ...
                  <input wire:model="user.email" disabled class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="email" placeholder="Provide User's Email">
                </div>
              </div>
        </div>
      </div>
